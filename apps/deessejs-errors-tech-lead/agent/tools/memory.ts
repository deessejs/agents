...
// This tool exposes the memory interface for the deessejs-errors-tech-lead agent.
// Scope defaults to 'shared' to mirror the existing agent pattern (no schema
// migration required). NOTE: this collides with general-assistant's writes —
// TODO: add a dedicated 'deessejs-errors' scope via a schema migration.
